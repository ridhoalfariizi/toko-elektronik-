...
<head>
    ...
    <meta name="description" content="Toko Elektronik - Admin Panel">
    <title>@yield('title', 'Toko Elektronik - Admin')</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Produk -->
            <li class="nav-item {{ request()->routeIs('produk.admin') ? 'active' : '' }}">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Toko Elektronik {{ date('Y') }}</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
